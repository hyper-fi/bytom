...
# data
`import "github.com/tendermint/go-amino/data"`
...
See <a href="https://github.com/tendermint/go-amino/data/blob/master/common_test.go">https://github.com/tendermint/go-amino/data/blob/master/common_test.go</a> to see
...
[binary.go](/src/github.com/tendermint/go-amino/data/binary.go) [bytes.go](/src/github.com/tendermint/go-amino/data/bytes.go) [docs.go](/src/github.com/tendermint/go-amino/data/docs.go) [json.go](/src/github.com/tendermint/go-amino/data/json.go) [wrapper.go](/src/github.com/tendermint/go-amino/data/wrapper.go) 
